gameStates.login = {
  ...
  preload: function() {
    ...
    this.car0 = game.add.sprite(
      game.camera.width / 2 - this.carMarginX,
      this.carY,
      'car0'
    );
    ...
    this.car0.events.onInputDown.add(function() {
      ...
      game.add
        .tween(this.car0)
        .to({ x: game.camera.width + 100 }, 1000, Phaser.Easing.Back.In, true)
    ...
    this.pedal = game.add.sprite(
      game.camera.width / 2,
      game.camera.height / 2 + 70,
      'pedal'
    );
    ...
    this.header = game.add.text(
      game.camera.width / 2,
      game.camera.height / 2 - 100,
      'Select a car',
      { font: '52px Arial', fill: '#111' }
    );
    ...
    this.pedalText = game.add.text(0, this.pedal.height / 2, 'GO!', {
      font: '26px Arial',
      fill: '#fff',
      stroke: '#000000',
      strokeThickness: 4,
